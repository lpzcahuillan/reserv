package com.lpzcahuillan.menu.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBadRequestException(BadRequestException ex, HttpServletRequest request) {
        log.warn("Solicitud inválida en menú: {}", ex.getMessage());
    ...
    public ResponseEntity<ProblemDetail> handleValidationException(org.springframework.web.bind.MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        log.warn("Error de validación en menú: {}", details);
    ...
    public ResponseEntity<ProblemDetail> handleGenericException(Exception ex, HttpServletRequest request) {
        log.error("Error inesperado en menú", ex);
